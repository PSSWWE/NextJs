...
export async function GET(
  ...
  try {
    ...
    if (!recalcBalances) {
      ...
      let paymentsListForVoucher: Array<{
        id: number;
        date: Date;
        amount: number;
        invoice: string | null;
      ...
      const pageRows = await prisma.vendorTransaction.findMany({
      ...
      let paginatedPaymentsList: Array<{
        id: number;
        date: Date;
        amount: number;
        invoice: string | null;
    ...
    let paymentsForVoucherHeavy: Array<{
      id: number;
      date: Date;
      amount: number;
      invoice: string | null;
    ...
    let paginatedPaymentsListRecalc: Array<{
      id: number;
      date: Date;
      amount: number;
      invoice: string | null;
